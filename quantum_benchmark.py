    ...
    def compile(self, N_exp):
        ...
        try:
            ...
            self.openql_comp.circuit(
                config_file=self.config_file_path, scheduler=scheduler, uniform_sched=uniform_sched, mapper=self.mapper, initial_placement=self.init_place, output_dir_name=self.output_dir, measurement=False)
